...
export function EmptyState({
  ...
  const config = {
    search: {
      ...
      hint: "Example: aaaaa-aa or a 64-char account identifier",
    },
    empty: {
      icon: <Search className="h-10 w-10 text-muted-foreground" />,
      title: "No Transactions Found",
      desc: 'This wallet has no recorded transactions in the selected time range. Try expanding to "All time".',
      hint: null,
    },
    cors: {
